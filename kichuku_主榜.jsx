...
for (rank = 3; rank > 0; rank -= 1) {
    ...
    VideoItemSize = RankVideoLayer.sourceRectAtTime(RankVideoLayer.inPoint, false);
    if (VideoItemSize.width / VideoItemSize.height >= VideoSize[0] / VideoSize[1]) {
        RankVideoLayer.property("Scale").setValueAtTime(Globaloffset + 8, [
            (VideoSize[0] / VideoItemSize.width) * 100,
            (VideoSize[0] / VideoItemSize.width) * 100,
        ]);
        RankVideoLayer.property("Scale").setValueAtTime(Globaloffset + 9, [
            (CompSize[0] / VideoItemSize.width) * 100,
            (CompSize[0] / VideoItemSize.width) * 100,
        ]);
        RankVideoLayer.property("Scale").setValueAtTime(Globaloffset + SingleLength - 5, [
            (CompSize[0] / VideoItemSize.width) * 100,
            (CompSize[0] / VideoItemSize.width) * 100,
        ]);
        RankVideoLayer.property("Scale").setValueAtTime(Globaloffset + SingleLength - 4, [
            (VideoSize[0] / VideoItemSize.width) * 100,
            (VideoSize[0] / VideoItemSize.width) * 100,
        ]);
    } else {
    ...
    RankVideoLayer.property("Position").setValueAtTime(Globaloffset + 8, [1200, 421]);
    RankVideoLayer.property("Position").setValueAtTime(Globaloffset + 9, [960, 540]);
    RankVideoLayer.property("Position").setValueAtTime(Globaloffset + SingleLength - 5, [960, 540]);
    RankVideoLayer.property("Position").setValueAtTime(Globaloffset + SingleLength - 4, [1200, 421]);
    AddAudioProperty(RankVideoLayer, 2, 1, Globaloffset, 1);
    AddAudioProperty(RankVideoLayer, 2, 1, Globaloffset + SingleLength - 1, 2);
    //RankVideoLayer.property("Audio Levels").setValueAtTime(Globaloffset, [-Infinity, -Infinity]);
    //RankVideoLayer.property("Audio Levels").setValueAtTime(Globaloffset + 1, [0, 0]);
    ...
    GreenMask.property("Despill Bias").setValue([0.5, 0.5, 0.5]);
    GreenMask.property("Unpremultiply Result").setValue(null);
    RankVideoMask2 = AddLayer(Part3, "mask_3", SingleLength, Globaloffset);
    RankVideoMask2.mask.addProperty("Mask");
    RankVideoMask2.mask(1).maskMode = MaskMode.ADD;
    RankVideoMask2.mask(1).inverted = true;
    RankVideoMask2.mask(1).property(1).expression =
        "mask(1).maskPath = createPath(points=[[525,40], [1875,40], [1875,805], [525,805]], inTangents=[], outTangents=[], is_closed=true)";
    RankVideoMask.property("Position").setValueAtTime(Globaloffset + 8, [960, 540]);
    RankVideoMask.property("Position").setValueAtTime(Globaloffset + 9, [618, 710]);
    RankVideoMask.property("Position").setValueAtTime(Globaloffset + SingleLength - 5, [618, 710]);
    RankVideoMask.property("Position").setValueAtTime(Globaloffset + SingleLength - 4, [960, 540]);
    RankVideoMask.property("Scale").setValueAtTime(Globaloffset + 8, [100, 100]);
    RankVideoMask.property("Scale").setValueAtTime(Globaloffset + 9, [143, 143]);
    RankVideoMask.property("Scale").setValueAtTime(Globaloffset + 9.16, [150, 150]);
    RankVideoMask.property("Scale").setValueAtTime(Globaloffset + SingleLength - 5.16, [150, 150]);
    RankVideoMask.property("Scale").setValueAtTime(Globaloffset + SingleLength - 5, [143, 143]);
    RankVideoMask.property("Scale").setValueAtTime(Globaloffset + SingleLength - 4, [100, 100]);
    RankVideoMask2.property("Position").setValueAtTime(Globaloffset + 8, [960, 540]);
    RankVideoMask2.property("Position").setValueAtTime(Globaloffset + 9, [618, 710]);
    RankVideoMask2.property("Position").setValueAtTime(Globaloffset + SingleLength - 5, [618, 710]);
    RankVideoMask2.property("Position").setValueAtTime(Globaloffset + SingleLength - 4, [960, 540]);
    RankVideoMask2.property("Scale").setValueAtTime(Globaloffset + 8, [100, 100]);
    RankVideoMask2.property("Scale").setValueAtTime(Globaloffset + 9, [143, 143]);
    RankVideoMask2.property("Scale").setValueAtTime(Globaloffset + 9.16, [150, 150]);
    RankVideoMask2.property("Scale").setValueAtTime(Globaloffset + SingleLength - 5.16, [150, 150]);
    RankVideoMask2.property("Scale").setValueAtTime(Globaloffset + SingleLength - 5, [143, 143]);
    RankVideoMask2.property("Scale").setValueAtTime(Globaloffset + SingleLength - 4, [100, 100]);

    RankDataLayer = AddLayer(Part3, rank + "_T", SingleLength, Globaloffset);
    RankDataLayer.property("Opacity").setValueAtTime(Globaloffset + 1, 0);
    RankDataLayer.property("Opacity").setValueAtTime(Globaloffset + 2, 100);
    RankDataLayer.property("Opacity").setValueAtTime(Globaloffset + SingleLength - 2, 100);
    RankDataLayer.property("Opacity").setValueAtTime(Globaloffset + SingleLength - 1, 0);
    RankDataLayer.property("Position").setValueAtTime(Globaloffset + 8, [960, 540]);
    RankDataLayer.property("Position").setValueAtTime(Globaloffset + 9, [618, 710]);
    RankDataLayer.property("Position").setValueAtTime(Globaloffset + SingleLength - 5, [618, 710]);
    RankDataLayer.property("Position").setValueAtTime(Globaloffset + SingleLength - 4, [960, 540]);
    RankDataLayer.property("Scale").setValueAtTime(Globaloffset + 8, [100, 100]);
    RankDataLayer.property("Scale").setValueAtTime(Globaloffset + 9, [143, 143]);
    RankDataLayer.property("Scale").setValueAtTime(Globaloffset + SingleLength - 5, [143, 143]);
    RankDataLayer.property("Scale").setValueAtTime(Globaloffset + SingleLength - 4, [100, 100]);
